...
<div class="gw-wizard" id="gw-wizard">
	...
	<section class="gw-wizard__panel" data-panel="1" aria-hidden="false">
		...
		<p><?php esc_html_e( 'This wizard installs the plugins your store needs, activates them, and imports professional demo content tailored for a power-tools retailer. You can re-run it any time from Appearance → GreenWorld Setup.', 'greenworld' ); ?></p>
	...
	<section class="gw-wizard__panel" data-panel="5" aria-hidden="true" hidden>
		...
		<p><?php esc_html_e( 'Next: verify your business details, review Merchant Compliance, and connect payments (M-Pesa, cards).', 'greenworld' ); ?></p>
